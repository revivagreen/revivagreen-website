    ...
    <div className=" text-black pt-26">
      <div className="container mx-auto py-20 px-4">
        <div className="text-center mb-16">
          <h1 className=" mb-4 text-3xl text-[#0067ff]   font-sans-serif font-semibold  text-center mb-12max-w-4xl mx-auto">Recycling Made Easy for Your Home</h1>
        ...
        <div className="max-w-4xl mx-auto bg-orange-400 p-8 sm:p-12 rounded-lg shadow-lg">
          <h2 className="text-2xl font-semibold text-white mb-8 text-center font-sans-serif sm:text-left">How It Works:</h2>
